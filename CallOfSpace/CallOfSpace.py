...
SHIP_COLORS = {
    "red": "RedSpaceship.png",
    "green": "GreenSpaceship.png",
    "blue": "BlueSpaceship.png",
}
LASER_COLORS = {
    "red": "pixel_laser_red.png",
    "green": "pixel_laser_green.png",
    "blue": "pixel_laser_blue.png",
    "yellow": "LaserShot2.png",
}

BG_IMAGE = "Galaxy2.jpg"
...
class Player(Ship):
    def __init__(self, x, y, health=PLAYER_HEALTH):
        ...
        self.laser_img = pygame.image.load(os.path.join(ASSET_DIR, "LaserShot2.png"))
...
def main():
    ...
    while run:
        ...
        bg_y += 10  # Adjust this value to control scrolling speed
        if bg_y >= HEIGHT:
            bg_y = 0
